...
#               and polygons, create a polygonal representation and append it to
...
import requests, zipfile, StringIO, arcpy, os, sys
...
def prepJSON(Shapefile):
    ...
    # GeoCore
    #
    arcpy.FeaturesToJSON_conversion(in_features=singlepart, out_json_file="C:/TEMP/IPN_FeaturesToJSON.json", format_json="FORMATTED", include_z_values="NO_Z_VALUES", include_m_values="NO_M_VALUES", geoJSON="GEOJSON")
...
if __name__ == '__main__':
    ...
    gdb = "C:\TEMP\census_subdivisions_2016_en.gdb"
